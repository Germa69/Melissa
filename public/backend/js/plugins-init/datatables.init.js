...
(function ($) {
    ...
    var table = $("#ListDatatableView").DataTable({
        ...
        oLanguage: {
            ...
            sLengthMenu:
                '<span class="fs-14">Hiển thị</span> <select style="display: none">' +
            ...
            sProcessing:
                'Loading <i class="fa fa-spinner" style="transition: 2s;"></i>',
            oPaginate: {
    ...
    var table = $("#carTable, #contractTable, #example4, #example5").DataTable({
        oLanguage: {
            sSearch: '<span class="fs-14">Tỉm kiếm: </span> ',
            sZeroRecords: "Không có dữ liệu nào trong bảng",
            sLengthMenu:
