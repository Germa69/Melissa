<div class="nav-header">
    <a href="index.html" class="brand-logo">
        <img src="{{ asset('public/common/icon/icons.png') }}" width="50px" />
        <span style="color: saddlebrown; display: inline-block; margin-left: 10px" id="textSP">MELISSA</span>
    </a>
                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ asset('public/uploads/avatar/' . Session::get('avatar')) }}" width="20"
                                alt="">
                            <div class="header-info">
                                <span>{{ Session::get('ten_admin') }}</span>
                                <small>
