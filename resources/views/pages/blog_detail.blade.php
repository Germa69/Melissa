...
@section('content')
    <section>
        <div class="container">
            ...
            <img src="{{ asset('public/frontend/images/other-image-fullscreen-1-1920x700.jpg') }}" class="img-responsive" alt="">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-12 pull-right">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="blog-post-details">Ducimus magni eveniet sit doloremque molestiae alias mollitia
                                vitae.</a></li>
                    </ul>
                </div>
